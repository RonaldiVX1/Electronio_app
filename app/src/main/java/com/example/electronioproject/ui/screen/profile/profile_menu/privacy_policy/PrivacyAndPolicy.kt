...
fun PrivacyAndPolicyScreen(
    ...
    viewModel: PrivacyAndPolicyViewModel = PrivacyAndPolicyViewModel()
) {
    val groupedPap by viewModel.groupedPrivacyAndPolicy.collectAsState()
